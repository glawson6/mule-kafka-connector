...
public class KafkaConnector {
    ...
    private Properties determineProperties(Properties properties, String propertyFileOverrides) {
        Properties newProperties = new Properties();
        if (null != propertyFileOverrides) {
            try {
                newProperties.load(resourceLoader.getResource(propertyFileOverrides).getInputStream());
            } catch (Exception e) {
                StringBuilder sb = new StringBuilder("Unable to load ");
                sb.append(propertyFileOverrides).append(" property file.");
    ...
    public void consumer(SourceCallback callback, @Optional String topic, @Optional String propertyFileOverrides) {
        ...
        Properties properties = determineProperties(getConsumerProperties(), propertyFileOverrides);
        if (null != topic) {
